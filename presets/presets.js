...
if (preset === 0){
    result += "macro PRESET_SKIRMISH_MAPS = []\nmacro PRESET_TDM_MAPS = []\n#!define PRESET_MAP_DATA /**/\n";
}
else if (preset in data) {
    result += `macro PRESET_SKIRMISH_MAPS = [${data[preset][1].toLowerCase()}]\n`;
    result += `macro PRESET_TDM_MAPS = [${data[preset][2].toLowerCase()}]\n`;
